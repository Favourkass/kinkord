...
ALTER TABLE "profile" ADD COLUMN "orientation" text;--> statement-breakpoint
ALTER TABLE "profile" ADD COLUMN "body_type" text;--> statement-breakpoint
ALTER TABLE "profile" ADD COLUMN "languages" jsonb DEFAULT '[]'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "profile" ADD COLUMN "last_seen_at" timestamp;--> statement-breakpoint
