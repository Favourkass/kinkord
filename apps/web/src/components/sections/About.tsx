  ...
  return (
    <section id="about" className="py-20 md:py-28 bg-[#0d0d0d]">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <SectionReveal>
          <p className="text-[10px] uppercase tracking-[0.4em] text-[#d4af37] mb-3">Our Story</p>
          <h2
        ...
        <SectionReveal delay={0.2}>
          ...
          <div className="relative border border-[#d4af37]/15 bg-[#0a0a0a] p-8 md:p-12">
            ...
            <p className="text-sm md:text-base text-[#888] leading-relaxed mb-8">
              Kinkord is more than a platform — it is a movement toward safer, more informed adult
              lifestyle spaces. Built with privacy, dignity and education at the core, Kinkord
              brings together a verified global community of adults committed to consent-first
              exploration.
            </p>
            <p className="text-xs text-[#555] mb-8 leading-relaxed">
              Learn more about our mission, community structure, values and future vision.
            </p>
