...
\r
`,a,"\r\n")),e.push(`--${d}--`),new c(e,{type:"multipart/form-data; boundary="+d})}])},87472,(a,b,c)=>{if(!globalThis.DOMException)try{let{MessageChannel:b}=a.r(37702),c=new b().port1,d=new ArrayBuffer;c.postMessage(d,[d,d])}catch(a){"DOMException"===a.constructor.name&&(globalThis.DOMException=a.constructor)}b.exports=globalThis.DOMException},52499,70552,a=>{"use strict";var b=a.i(2157),c=a.i(50227),d=a.i(87472),e=a.i(46403),f=a.i(96624);let{stat:g}=b.promises,h=(a,b,c="")=>new f.default([new j({path:b,size:a.size,lastModified:a.mtimeMs,start:0})],{type:c}),i=(a,b,d="")=>new e.default([new j({path:b,size:a.size,lastModified:a.mtimeMs,start:0})],(0,c.basename)(b),{type:d,lastModified:a.mtimeMs});class j{#h;#i;constructor(a){this.#h=a.path,this.#i=a.start,this.size=a.size,this.lastModified=a.lastModified}slice(a,b){return new j({path:this.#h,lastModified:this.lastModified,size:b-a,start:this.#i+a})}async *stream(){let{mtimeMs:a}=await g(this.#h);if(a>this.lastModified)throw new d.default("The requested file could not be read, typically due to permission problems that have occurred after a reference to a file was acquired.","NotReadableError");yield*(0,b.createReadStream)(this.#h,{start:this.#i,end:this.#i+this.size-1})}get[Symbol.toStringTag](){return"Blob"}}a.s(["blobFrom",0,(a,b)=>g(a).then(c=>h(c,a,b)),"blobFromSync",0,(a,c)=>h((0,b.statSync)(a),a,c),"fileFrom",0,(a,b)=>g(a).then(c=>i(c,a,b)),"fileFromSync",0,(a,c)=>i((0,b.statSync)(a),a,c)],52499),a.s(["File",()=>e.default],70552)}];

//# sourceMappingURL=node_modules__pnpm_0h4uml2._.js.map