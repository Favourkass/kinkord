...
\r
`,e,"\r\n")),n.push(`--${o}--`),new r(n,{type:"multipart/form-data; boundary="+o})}])},93705,(e,t,r)=>{if(!globalThis.DOMException)try{let{MessageChannel:t}=e.r(37702),r=new t().port1,o=new ArrayBuffer;r.postMessage(o,[o,o])}catch(e){"DOMException"===e.constructor.name&&(globalThis.DOMException=e.constructor)}t.exports=globalThis.DOMException},94163,27071,e=>{"use strict";var t=e.i(2157),r=e.i(50227),o=e.i(93705),n=e.i(91558),i=e.i(87566);let{stat:a}=t.promises,l=(e,t,r="")=>new i.default([new u({path:t,size:e.size,lastModified:e.mtimeMs,start:0})],{type:r}),s=(e,t,o="")=>new n.default([new u({path:t,size:e.size,lastModified:e.mtimeMs,start:0})],(0,r.basename)(t),{type:o,lastModified:e.mtimeMs});class u{#l;#s;constructor(e){this.#l=e.path,this.#s=e.start,this.size=e.size,this.lastModified=e.lastModified}slice(e,t){return new u({path:this.#l,lastModified:this.lastModified,size:t-e,start:this.#s+e})}async *stream(){let{mtimeMs:e}=await a(this.#l);if(e>this.lastModified)throw new o.default("The requested file could not be read, typically due to permission problems that have occurred after a reference to a file was acquired.","NotReadableError");yield*(0,t.createReadStream)(this.#l,{start:this.#s,end:this.#s+this.size-1})}get[Symbol.toStringTag](){return"Blob"}}e.s(["blobFrom",0,(e,t)=>a(e).then(r=>l(r,e,t)),"blobFromSync",0,(e,r)=>l((0,t.statSync)(e),e,r),"fileFrom",0,(e,t)=>a(e).then(r=>s(r,e,t)),"fileFromSync",0,(e,r)=>s((0,t.statSync)(e),e,r)],94163),e.s(["File",()=>n.default],27071)}];

//# sourceMappingURL=node_modules__pnpm_12tlgk5._.js.map